...
namespace TeknikServis
{
    ...
    public partial class DbTeknikServisEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> maxkategorıurun()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("maxkategorıurun");
        }
    
        public virtual ObjectResult<MAXURUNMARKA_Result> MAXURUNMARKA()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MAXURUNMARKA_Result>("MAXURUNMARKA");
        }
        ...
        public virtual ObjectResult<string> MAXURUNMARKA1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("MAXURUNMARKA1");
        }
    
        public virtual ObjectResult<string> enfazlacariil()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("enfazlacariil");
        }
    }
}
